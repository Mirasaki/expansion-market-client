 ...
 * handling commands in this template. Exported from `/client/handlers/commands.js`.
...
const cleanAPIData = (cmd) => {
  ...
  if (cmd.data.description?.length > 100) cmd.data.description = `${cmd.data.description.slice(0, 97)}...`;
